...
#def _learningRate_decay(args, global_step):
#    
#   num_batches_per_epoch = args.NUM_EXAMPLES_PER_EPOCH_FOR_TRAIN /args.bsize
#   decay_steps = np.float32(num_batches_per_epoch * args.NUM_EPOCHS_PER_DECAY)
#   power = np.float32(global_step/decay_steps)
#   lr = args.INITIAL_LEARNING_RATE * math.pow(args.LEARNING_RATE_DECAY_FACTOR, power)
#   lr = np.float32(lr)
#   return lr
